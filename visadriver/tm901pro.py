...
class TM901pro():
    ...
    def read_mag_field_mT(self):
        ...
        screenshot_region((150, 310, 380, 120), 'value.png')
        ...
        img = Image.open('value.png')
        ep2_str = recognize_numerical_value( img.crop((  0, 0,  70, 120)) )
        ep1_str = recognize_numerical_value( img.crop(( 70, 0, 140, 120)) )
        ep0_str = recognize_numerical_value( img.crop((140, 0, 210, 120)) )
        em1_str = recognize_numerical_value( img.crop((237, 0, 307, 120)) )
        em2_str = recognize_numerical_value( img.crop((307, 0, 377, 120)) )
